...
WRF_dataset = local.load_WRF_2d_files_RAIN(file_path='./data_WRF04/', filename_pattern=['wrf2dout*'])
...
dump(histo2d, open('WRF04_JPDF_example.pickle','wb'))
...
draw_JPDF(plot_data=np.transpose(histo2d), plot_level=plot_level, titles='', 
          ...
          output_file='WRF04_JPDF_example')
